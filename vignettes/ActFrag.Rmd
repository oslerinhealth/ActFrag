...
In this version, we focus on the fragmentation metrics that describe time accumulation strategy. We have the funcions to calcualte the following features
